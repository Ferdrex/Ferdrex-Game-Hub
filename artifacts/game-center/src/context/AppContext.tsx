...
const TRANSLATIONS: Record<string, Record<Language, string>> = {
  ...
  "term.diff.easy":      { en: "[ EASY ]", es: "[ FÁCIL ]" },
  "term.diff.medium":    { en: "[ MEDIUM ]", es: "[ MEDIO ]" },
  "term.diff.hard":      { en: "[ HARD ]", es: "[ DIFÍCIL ]" },
  "term.diff.ultra":     { en: "[ ULTRA HARD ]", es: "[ ULTRA DIFÍCIL ]" },
  "term.letters":        { en: "letters", es: "letras" },
  "term.words":          { en: "words", es: "palabras" },
